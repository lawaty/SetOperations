  ...
  private void performOperation(int index, Action action) {
    switch (action) {
      case COMPLEMENT:
        ...
        System.out.println("Result: " + complementResult.package SetOperations;
...
());
      ...
      case CARDINALITY:
        ...
        break;
      case PRINT:
        System.out.println("Set elements: " + sets.get(index).package SetOperations;
...
());
  ...
  private void performOperation(int index1, int index2, Action action) {
    switch (action) {
      case UNION:
        BitSet unionResult = sets.get(index1).union(sets.get(index2));
        System.out.println(sets.get(index1).getElempackage SetOperations;
...
ents());
        System.out.println("Union Result: " + unionResult.package SetOperations;
...
());
      ...
      case INTERSECTION:
        BitSet intersectionResult = sets.get(index1).intersection(sets.get(index2));
        System.out.println("Intersection Result: " + intersectionResult.package SetOperations;
...
());
      ...
      case DIFFERENCE:
        BitSet differenceResult = sets.get(index1).difference(sets.get(index2));
        System.out.println("Difference Result: " + differenceResult.package SetOperations;
